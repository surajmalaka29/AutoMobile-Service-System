    ...
    <div class="header">
        <nav class="navbar navbar-expand-sm fixed-top">
            <div class="container-fluid">
                <a class="navbar-brand" href="/AutoMobile Project/index.php">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="/AutoMobile Project/index.php">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/AutoMobile Project/service.php">Services</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/AutoMobile Project/appointment.php">Appointments</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/AutoMobile Project/AboutUs.php">About</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/AutoMobile Project/contactUs.php">Contact Us</a>
                        </li>
                        <li class="nav-item d-sm-none">
                            <a class="nav-link" href="/AutoMobile Project/login.php">
                    ...
                    <div class="dropdown">
                        <ul class="nav-item-dropdown">
                            <li class="dropdown-item">
                                <a class="drop-link" href="/AutoMobile Project/index.php">Home</a>
                            </li>
                            <li class="dropdown-item">
                                <a class="drop-link" href="/AutoMobile Project/service.php">Services</a>
                            </li>
                            <li class="dropdown-item">
                                <a class="drop-link" href="/AutoMobile Project/appointment.php">Appointments</a>
                            </li>
                            <li class="dropdown-item">
                                <a class="drop-link" href="/AutoMobile Project/AboutUs.php">About</a>
                            </li>
                            <li class="dropdown-item">
                                <a class="drop-link" href="/AutoMobile Project/contactUs.php">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                </div>
