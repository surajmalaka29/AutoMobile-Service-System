function fetchNotifications() {
    fetch('/AutoMobile Project/User/functions/notification_actions.php?action=fetch')
...
function markAsRead(notificationId, notificationDiv) {
    fetch(`/AutoMobile Project/User/functions/notification_actions.php?action=mark_as_read&id=${notificationId}`, { method: 'POST' })
    .then(response => response.json())
    .then(data => {
        if (data.success) {
...
document.getElementById('mark-all-read').addEventListener('click', function() {
    fetch('/AutoMobile Project/User/functions/notification_actions.php?action=mark_all_read', { method: 'POST' })
    .then(response => response.json())
    .then(data => {
        if (data.success) {
            markAllAsRead();
...
document.getElementById('delete-read').addEventListener('click', function() {
    fetch('/AutoMobile Project/User/functions/notification_actions.php?action=delete_read', { method: 'POST' })
    .then(response => response.json())
    .then(data => {
        if (data.success) {
            deleteReadMessages();
